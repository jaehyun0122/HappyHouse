...
@Service
public class JwtImple implements JwtService{
    private static final String SALT = "rivenSecet";
    private static final int EXPIRE_MINUTES = 60;
    public static final Logger logger = LoggerFactory.getLogger(JwtImple.class);
    @Override
...
//			return testMap;
    ...
    public String getNickname() {
        return (String) this.get("member").get("nickname");
    }
}
